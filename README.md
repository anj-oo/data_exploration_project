...
Built a consolidated KPI report using UNION for a quick business overview
...
Analysed customer distribution by country and gender
...
-----------------------
Identified the top 5 and bottom 5 products by revenue
Analysed product categories generating maximum revenue
Calculated average cost per category, helping assess profitability

📅 Time-Based Insights
-----------------------
Determined the first and last order dates to understand the business activity range
Measured order duration in months
Analysed customer age distribution (youngest vs oldest)
...
Ensure data is correctly mapped to the table schema
Run Exploration Queries
Execute the SQL queries step-by-step
Analyse outputs for insights on sales, customers, and products
